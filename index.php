<?php
    ...
    { 
        ...
        //echo json_encode(strlen($output) > 0);
        
        //echo true;
    } 
     
    else if (isset($_POST['_createZip'])) // fold
    {
        shell_exec('zip -r /var/www/html/archive.zip ' . $_POST['_createZip']);
    }
   ...
   <body>
       ...
       <script type="text/javascript">
            ...
            webix.ready(function () {
                ...
                // Ctrl key actions
                document.addEventListener("keydown", function(e) // fold
                {
                ...
                webix.ui({
                    ...
                    on: {
                        ...
                        onItemClick : function (id, e, node) // fol
                        {
                            ...
                            else if (id == "Download") // fol
                            {
                                if (contextPath.includes('.')) {
                                    
                                    var link = document.createElement('a');
                                    document.body.appendChild(link);
                                    link.href = "http://185.163.124.170/" + contextPath;
                                    link.click();
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        data : {
                                            _createZip : contextPath,
                                        },
                                        success:function (response) {
                                            
                                            var link = document.createElement('a');
                                            document.body.appendChild(link);
                                            link.href = "http://185.163.124.170/archive.zip";
                                            link.click();
                                            document.body.removeChild(link);
                            ...
                            else if (id == "Open in new tab") // fold
                            {
                            ...
                            cols : [
                                {
                                    ...
                                    on:{
                                        ...
                                        onItemClick : function(id, e, node) // fold
                                        {
                                            ...
                                            // si l'item cliqué n'est pas un dossier (donc un fichier)
                ...
                // tern sert à propsoer les args de fct si ceux si sont documents
                ...
                */
                ...
                editor.session.__proto__.autoFold = function() // fol
                {
                    ...
                    for (let row = 0; row < this.getLength(); row++) {
                        ...
                        } else if (this.getLine(row).startsWith(indentation + closer)) {
